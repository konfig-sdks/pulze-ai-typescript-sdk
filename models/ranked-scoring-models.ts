 ...
 * 
 * @export
 * @interface RankedScoringModels
 */
export interface RankedScoringModels {
    /**
     * 
     * @type {Array<{ [key: string]: number; }>}
     * @memberof RankedScoringModels
     */
    'best_models'?: Array<{ [key: string]: number; }>;
    /**
     * 
     * @type {Array<{ [key: string]: number; }>}
     * @memberof RankedScoringModels
     */
    'candidates'?: Array<{ [key: string]: number; }>;
}
