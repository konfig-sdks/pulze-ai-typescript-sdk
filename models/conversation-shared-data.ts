 ...
 * 
 * @export
 * @interface ConversationSharedData
 */
export interface ConversationSharedData {
    /**
     * 
     * @type {ConversationShare}
     * @memberof ConversationSharedData
     */
    'data': ConversationShare;
    /**
     * 
     * @type {Array<Array<Request>>}
     * @memberof ConversationSharedData
     */
    'messages': Array<Array<Request>>;
}
