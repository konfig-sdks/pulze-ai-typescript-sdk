...
import { BillingTransactionItem } from './billing-transaction-item';

/**
 * 
 * @export
 * @interface BillingTransactions
 */
export interface BillingTransactions {
    /**
     * The list of Transaction items
     * @type {Array<BillingTransactionItem>}
     * @memberof BillingTransactions
     */
    'data'?: Array<BillingTransactionItem>;
}
