...
import { OrgIntegrationItem } from './org-integration-item';

/**
 * 
 * @export
 * @interface OrgIntegrationUpdate
 */
export interface OrgIntegrationUpdate {
    /**
     * 
     * @type {OrgIntegrationItem}
     * @memberof OrgIntegrationUpdate
     */
