 ...
 * 
 * @export
 * @interface GetTableSortParams
 */
export interface GetTableSortParams {
    /**
     * 
     * @type {string}
     * @memberof GetTableSortParams
     */
    'col': string;
    /**
     * 
     ...
     * @memberof GetTableSortParams
     */
    'order': GetTableSortParamsOrderEnum;
}

type GetTableSortParamsOrderEnum = 'asc' | 'desc'
