 ...
 * 
 * @export
 * @interface BodyAppUploadCustomDataV1AppsCustomDataAppIdPost
 */
export interface BodyAppUploadCustomDataV1AppsCustomDataAppIdPost {
    /**
     * 
     * @type {Array<Uint8Array | File | buffer.File>}
     * @memberof BodyAppUploadCustomDataV1AppsCustomDataAppIdPost
     */
