...
import { InviteFormEmail } from './invite-form-email';

/**
 * 
 * @export
 * @interface InviteFormRequest
 */
export interface InviteFormRequest {
    /**
     * 
     * @type {Array<InviteFormEmail>}
     * @memberof InviteFormRequest
     */
    'emails': Array<InviteFormEmail>;
    /**
     * 
     * @type {string}
     * @memberof InviteFormRequest
