...
import { PulzeDefaultModelData } from './pulze-default-model-data';

/**
 * 
 * @export
 * @interface PulzeToggleModelResponse
 */
export interface PulzeToggleModelResponse {
    /**
     * 
     * @type {boolean}
     * @memberof PulzeToggleModelResponse
     */
    'active'?: boolean;
    /**
     * 
     * @type {PulzeDefaultModelData}
     * @memberof PulzeToggleModelResponse
     */
